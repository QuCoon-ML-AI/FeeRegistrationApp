...
import com.pwb.feeRegistrationApp.repository.database.UserRepository
import com.pwb.feeRegistrationApp.repository.database.UserOtpRepository
import com.pwb.feeRegistrationApp.model.entity.UserOtp
import com.pwb.feeRegistrationApp.model.entity.User
import com.pwb.feeRegistrationApp.repository.database.LoginHistoryRepository
import com.pwb.feeRegistrationApp.repository.database.RoleRepository
import com.pwb.feeRegistrationApp.repository.database.RolePrivilegeRepository
import com.pwb.feeRegistrationApp.repository.database.PrivilegeRepository
import com.pwb.feeRegistrationApp.repository.database.ModuleRepository
...
class AuthenticationService(
   ...
   private val environment: Environment
	...
	fun loadAppConfig(): BaseResponse{
		//TODO LOAD MODULES
		val moduleNames = listOf("USER","FEE","REGISTRATION","USER_OTP","LOGIN_HISTORY","PRIVILEGE","ROLE","ROLE_PRIVILEGE","MODULE","AUDIT_LOG")
