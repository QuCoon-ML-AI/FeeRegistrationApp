...
import com.pwb.feeRegistrationApp.repository.database.query.FeeQuery
...
interface FeeRepository{
	...
	fun readByFeeName(feeName: String):MutableList<Fee>
...
class FeeRepositoryImpl(private val environment: Environment): FeeRepository{
	...
	override fun readByFeeName(feeName: String):MutableList<Fee>{
		return environment.databaseUtil?.sql2oConnection!!
				.createQueryWithoutOnMappingFailure(FeeQuery.READ_BY_FEE_NAME)
				.addParameter("feeName", feeName)
				.executeAndFetch(Fee::class.java)
	}
