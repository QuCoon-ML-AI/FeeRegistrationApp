...
import com.pwb.feeRegistrationApp.repository.database.query.RegistrationQuery
...
interface RegistrationRepository{
	...
	fun readByRegistrationUserId(registrationUserId: Int):MutableList<Registration>
...
class RegistrationRepositoryImpl(private val environment: Environment): RegistrationRepository{
	...
	override fun readByRegistrationUserId(registrationUserId: Int):MutableList<Registration>{
		return environment.databaseUtil?.sql2oConnection!!
				.createQueryWithoutOnMappingFailure(RegistrationQuery.READ_BY_REGISTRATION_USER_ID)
				.addParameter("registrationUserId", registrationUserId)
				.executeAndFetch(Registration::class.java)
	}
